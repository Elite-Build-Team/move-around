...
3. Ο χρήστης επιλέγει κάποια αναφορά.
...
### Βασική ροή "Βλάβες υπό επισκευή"
...
## Υπάλληλος
### Βασική Ροή "Προγραμματισμένες Επισκέψεις":
1. Ο υπάλληλος πατάει την επιλογή "Προγραμματισμένες Επισκέψεις".
...
### Εναλλακτική Ροή 1
3.1.1. Ο υπάλληλος κάνει προεπισκόπηση την αίτηση.  
...
3.2.2 Το σύστημα εμφανίζει στο χάρτη τα parkings για Α.Μ.Ε.Α. της κοντινής περιοχής.  
