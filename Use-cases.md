...
### v0.4
Οι σημαντικές αλλαγές από το v0.3 στο v0.4 έχουν υπογραμμιστεί με \textcolor{blue}{μπλέ} χρώμα.

* Το Use Case 9 διασπάστηκε κατάλληλα στο Use Case Diagram
* Use Case 1: Στο βήμα 8 της βασικής ροής προστέθηκε η περιγραφή πως το σύστημα βάζει την Αναφορά προβλήματος στις αναφορές του χρήστη (Αναφορές μου) και στο Χάρτη Πρόσβασης
...
* Use Case 9: Διασπάστηκε σε Use Case 9 () και Use Case 10(). To Use Case 9 περιέχει την επιλογή "Like" και την προσθήκη πρότασης AFP ενώ το Use Case 10 περιέχει την τροποποίηση πρότασης AFP και τη διαγραφή πρότασης AFP. Οι δύο τελευταίες εναλλακτικές ροές έγιναν νέο Use Case(10).
...
5. \textcolor{blue}{Ο υπάλληλος του Δήμου επιλέγει μία τοποθεσία στο χάρτη}.
6. \textcolor{blue}{Το σύστημα ελέγχει αν ο υπάλληλος του Δήμου επέλεξε τοποθεσία στο χάρτη και εμφανίζει την οθόνη συμπλήρωσης  στοιχείων}.
7. \textcolor{blue}{Ο υπάλληλος του Δήμου συμπληρώνει έναν ορισμό και μία περιγραφή}.
8. \textcolor{blue}{Το σύστημα ελέγχει αν ο υπάλληλος συμπλήρωσε ορισμό και περιγραφή και εμφανίζει την οθόνη επιβεβαίωσης}.
