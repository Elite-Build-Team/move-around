...
## Changelog
### v0.4
* Use Case 3: Στο βήμα 6 της βασικής ροής προστέθηκε η περιγραφή πως το σύστημα ανακτά την συγκεκριμένη αναφορά από τις Pending Issues και τα δεδομένα της από τη κλάση Reported Issues.
* Use Case 5: 
