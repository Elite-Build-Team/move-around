...
1. Ο υπάλληλος του Δήμου επιλέγει "Διαχείριση Αναφορών".
...
1.  Ο υπάλληλος του Δήμου επιλέγει "Διαχείριση Αναφορών".
2.  Το σύστημα εμφανίζει την οθόνη Διαχείρισης αναφορών.
2.	Ο υπάλληλος του Δήμου πατάει την επιλογή "Βλάβες υπό Επισκευή".
...
1. Ο υπάλληλος του Δήμου πατάει στη κύρια οθόνη την επιλογή "Ενημέρωση Χάρτη".
2. Το σύστημα εμφανίζει την οθόνη Ενημέρωσης Χάρτη.
3. Ο υπάλληλος του Δήμου πατάει την επιλογή "Δημιουργία Υποδομής".
